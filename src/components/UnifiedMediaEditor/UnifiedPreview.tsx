...
function VideoPreview({
  ...
  return (
    <div className="h-full p-6 relative" onDragOver={onDragOver} onDrop={onDrop}>
      ...
      <div className="h-full flex items-center justify-center">
        <div className={`flex items-center justify-center h-full ${selectedSources.length > 0 ? 'w-[calc(100%-200px)]' : 'w-full'
          }`}>
          <div
            className={`bg-muted rounded-xl flex items-center justify-center animate-fade-in overflow-hidden relative ${aspectRatio === '16:9' ? 'aspect-video w-full max-h-full' :
