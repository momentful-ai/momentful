...
function VideoPreview({
  ...
  return (
    <div className="h-full p-6" onDragOver={onDragOver} onDrop={onDrop}>
      <div className="max-w-7xl mx-auto h-full flex items-center justify-center gap-6">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="w-full flex items-center justify-center max-h-[calc(100vh-200px)]">
            <div
              className={`bg-muted rounded-xl flex items-center justify-center animate-fade-in overflow-hidden ${
                ...
                aspectRatio === '9:16' ? 'aspect-[9/16] w-full max-w-md max-h-[calc(100vh-200px)]' :
                aspectRatio === '1:1' ? 'aspect-square w-full max-w-2xl max-h-[calc(100vh-200px)]' :
                'aspect-[4/5] w-full max-w-xl max-h-[calc(100vh-200px)]'
              }`}
            >
